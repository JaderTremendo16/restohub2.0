...
const MapPicker = ({ lat, lng, onChange, address, suggestedCenter }) => {
    console.log("MapPicker Props:", { lat, lng, hasOnChange: typeof onChange === 'function', address, suggestedCenter });
    ...
    const reverseGeocode = async (newLat, newLng) => {
        console.log("Reverse Geocoding:", newLat, newLng, "Type of onChange:", typeof onChange);
        setLoading(true);
        try {
