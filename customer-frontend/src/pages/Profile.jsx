  ...
  if (loadingCountries || loadingLocations) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4 text-slate-400 font-bold">
        ...
        <p className="text-xs uppercase tracking-widest">Cargando tu perfil dinámico...</p>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">Gestiona tu información personal y sede preferida.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-700 px-1">Sede Preferida</label>
                <div className="relative">
        ...
        <div className="space-y-6">
          <div className="bg-brand-dark rounded-[2.5rem] p-8 text-white space-y-6 shadow-2xl shadow-black/20">
            ...
            <h4 className="text-xl font-black italic uppercase tracking-tight">¿Cambias de ambiente?</h4>
            <p className="text-slate-400 text-sm font-medium leading-relaxed">
              Al actualizar tu sede, el menú y las promociones se ajustarán automáticamente a tu nueva ubicación.
            </p>
            <button
              type="submit"
              disabled={updating}
