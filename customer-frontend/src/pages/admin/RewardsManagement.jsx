...
import { Gift, Plus, Pencil, Power, Package, Star, AlertCircle } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        <div>
          ...
          <p className="text-slate-500 mt-1 font-medium">Gestiona los premios y controla el inventario de canjes.</p>
        </div>
        <button 
      ...
      {loading ? (
        <div className="py-20 text-center text-slate-400">Cargando catálogo de premios...</div>
      ) : rewards.length === 0 ? (
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  placeholder="Ej: Plato Especial Gratis"
                />
              </div>
